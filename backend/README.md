...
## Project Structure
    ...
    ├── mithileshtiwari_dev_54509  # Django project configurations
...
1. Clone this repo and `cd mithileshtiwari_dev_54509`
...
2. Clone this repo and `cd mithileshtiwari_dev_54509`
